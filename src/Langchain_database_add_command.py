...
help_file_path = f'/mnt/d/Ubantu_run/MetaOpenFOAM/database/openfoam_command_helps.txt'
...
persist_directory = f'/mnt/d/Ubantu_run/MetaOpenFOAM/database/openfoam_command_helps'
